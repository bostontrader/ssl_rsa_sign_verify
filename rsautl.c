...
# include <openssl/pem.h> // EVP_PKEY_get1_RSA
...
int rsautl_main(int argc, char **argv)
{
    ...
    // char *passinarg = NULL, *prog;
    char *passin = NULL;
    char *prog;
    char rsa_mode = RSA_VERIFY;
    char key_type = KEY_PRIVKEY;
