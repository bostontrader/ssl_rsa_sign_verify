...
//# include "e_os.h" /ss struct timeval for DTLS ss/
...
//ss (1L <<  6) was OPT_FMT_NETSCAPE, but wasn't used ss/
...
/* We need both wrap and the "real" function because libcrypto uses both. ss/
...
/ss Functions defined in ca.c and also used in ocsp.c ss/
...
# define DB_serial       3      /ss index - unique ss/
# define DB_file         4
# define DB_name         5      /ss index - unique when active and not
                                 * disabled ss/
# define DB_NUMBER       6

# define DB_TYPE_REV     'R'    /ss Revoked  ss/
# define DB_TYPE_EXP     'E'    /ss Expired  ss/
# define DB_TYPE_VAL     'V'    /ss Valid ; inserted with: ca ... -valid ss/
# define DB_TYPE_SUSP    'S'    /ss Suspended  ss/
...
/ss See OPT_FMT_xxx, above. ss/
/ss On some platforms, it's important to distinguish between text and binary
...
// # define FORMAT_TEXT    (1 | B_FORMAT_TEXT)     /ss Generic text ss/
# define FORMAT_BINARY   2                      // Generic binary
// # define FORMAT_BASE64  (3 | B_FORMAT_TEXT)     /ss Base64 ss/
// # define FORMAT_ASN1     4                      /ss ASN.1/DER ss/
# define FORMAT_PEM     (5 | B_FORMAT_TEXT)
// # define FORMAT_PKCS12   6
// # define FORMAT_SMIME   (7 | B_FORMAT_TEXT)
// # define FORMAT_ENGINE   8                      /ss Not really a file format ss/
// # define FORMAT_PEMRSA  (9 | B_FORMAT_TEXT)     /ss PEM RSAPubicKey format ss/
// # define FORMAT_ASN1RSA  10                     /ss DER RSAPubicKey format ss/
// # define FORMAT_MSBLOB   11                     /ss MS Key blob format ss/
// # define FORMAT_PVK      12                     /ss MS PVK file format ss/
// # define FORMAT_HTTP     13                     /ss Download using HTTP ss/
// # define FORMAT_NSS      14                     /ss NSS keylog format ss/
